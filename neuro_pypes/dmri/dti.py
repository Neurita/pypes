...
def attach_spm_fsl_dti_preprocessing(main_wf, wf_name="spm_fsl_dti_preprocessing"):
    ...
    regexp_subst = [
        ...
        (r"diff/tissues/rc1{anat}_corrected\.nii$", "diff/tissues/gm_{diff}.nii"),
        (r"diff/tissues/rc2{anat}_corrected\.nii$", "diff/tissues/wm_{diff}.nii"),
        (r"diff/tissues/rc3{anat}_corrected\.nii$", "diff/tissues/csf_{diff}.nii"),
        (r"diff/rm{anat}_corrected\.nii$",          "diff/{anat}_{diff}.nii"),
    ]
    ...
    main_wf.connect([
        ...
        (anat_output,    coreg_dti_wf, [
            ("tissues_native", "dti_co_input.tissues"),
    ...
    if do_atlas:
            main_wf.connect([
                (anat_output,  coreg_dti_wf, [("atlas_anat", "dti_co_input.atlas_anat")]),
