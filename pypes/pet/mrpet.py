...
#
# def _attach_spm_mrpet_grouptemplate_preprocessing(main_wf, wf_name="spm_mrpet_grouptemplate_preproc"):
#     """ Attach a PET pre-processing workflow that uses SPM12 to `main_wf`.
#     This workflow needs MPRAGE pre-processing workflow.
#
#     Nipype Inputs for `main_wf`
#     ---------------------------
#     Note: The `main_wf` workflow is expected to have an `input_files` and a `datasink` nodes.
...
#     main_wf: nipype Workflow
#     """
#     main_wf = attach_spm_mrpet_preprocessing(main_wf, wf_name=wf_name, do_group_template=True)
#
#     # Dependency workflows
#     datasink = get_datasink    (main_wf)
#     pet_wf   = main_wf.get_node(wf_name)
#
#     # Connect the nodes
#     main_wf.connect([
#                      (pet_wf, datasink, [
